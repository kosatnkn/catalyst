...
// MariaDBTxAdapter is used to handle postgres db transactions.
type MariaDBTxAdapter struct {
	dba adapters.DBAdapterInterface
}

// NewPostgresTxAdapter creates a new Postgres transaction adapter instance.
func NewMariaDBTxAdapter(dba adapters.DBAdapterInterface) adapters.DBTxAdapterInterface {

	return &MariaDBTxAdapter{
		dba: dba,
	}
}

// Wrap runs the content of the function in a single transaction.
func (a *MariaDBTxAdapter) Wrap(ctx context.Context, fn func(ctx context.Context) (interface{}, error)) (interface{}, error) {
...
func (a *MariaDBTxAdapter) attachTx(ctx context.Context) (context.Context, error) {
