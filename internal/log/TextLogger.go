...
// TextLogger is used to provide structured log messages.
type TextLogger struct {
	cfg Config
}

// newTextLogger creates a new Log adapter instance.
func newTextLogger(cfg Config) (adapters.LogAdapterInterface, error) {
	a := &TextLogger{
		cfg: cfg,
	}
...
func (a *TextLogger) AddTraceID(ctx context.Context, id string) context.Context {
...
func (a *TextLogger) AppendTracePoint(ctx context.Context, point string) context.Context {
...
func (a *TextLogger) Error(ctx context.Context, message string, options ...interface{}) {
	a.log(ctx, levelError, message, options...)
}

// Debug logs a message as of debug type.
func (a *TextLogger) Debug(ctx context.Context, message string, options ...interface{}) {
	a.log(ctx, levelDebug, message, options...)
}

// Info logs a message as of information type.
func (a *TextLogger) Info(ctx context.Context, message string, options ...interface{}) {
	a.log(ctx, levelInfo, message, options...)
}

// Warn logs a message as of warning type.
func (a *TextLogger) Warn(ctx context.Context, message string, options ...interface{}) {
...
func (a *TextLogger) log(ctx context.Context, logLevel string, message string, options ...interface{}) {
...
func (a *TextLogger) formatMessage(ctx context.Context, logLevel string, message string, options ...interface{}) string {
...
func (a *TextLogger) toConsole(message string) {
	fmt.Println(message)
}
