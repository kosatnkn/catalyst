...
func Handle(ctx context.Context, err error, log adapters.LogAdapterInterface) (any, int) {
	switch err.(type) {
...
func HandleValidatorErrors(ctx context.Context, errs map[string]string, log adapters.LogAdapterInterface) (any, int) {
